...
<title>Rekap Sholat Dhuha</title>
...
<a
href="cetak_rekap_dhuha.php?kelas=<?= urlencode($kelas) ?>&nama=<?= urlencode($nama) ?>&bulan=<?= $bulan ?>&tahun=<?= $tahun ?>"
target="_blank"
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="alert alert-success">
            ...
            <strong>Total Kehadiran Sholat Dhuha :</strong>
            <?= $totalKehadiran ?>
