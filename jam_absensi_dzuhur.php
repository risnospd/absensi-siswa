...
// Query rekap HANYA jam_dzuhur
$sql = "
    SELECT a.id, s.id AS siswa_id, s.nama, s.kelas, a.jam_dzuhur, a.status
    FROM absensi a
...
<head>
<meta charset="UTF-8">
<title>Rekap Kehadiran Jam Dzuhur</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css">
</head>
<body class="container mt-4">
<h2>Rekap Kehadiran Jam Dzuhur</h2>
    ...
    <?php if (mysqli_num_rows($data) > 0): ?>
      <?php $no=1; while($row = mysqli_fetch_assoc($data)): ?>
        <tr>
          ...
          <td><?= htmlspecialchars($row['jam_dzuhur'] ?? '-') ?></td>
